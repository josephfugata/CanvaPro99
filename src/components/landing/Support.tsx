          ...
          <Card className="bg-card/60 dark:bg-card/40 backdrop-blur-lg border-border/50 shadow-md p-6">
            <CardHeader className="flex flex-row items-center gap-4">
              ...
              <div>
                ...
                <CardDescription className="text-base text-muted-foreground">
                  Mag-message sa amin sa <a href="https://m.me/100091605335356" target="_blank" rel="noopener noreferrer" className="underline">Messenger</a> para sa mas mabilis na kasagutan.
                </CardDescription>
              </div>
            </CardHeader>
          </Card>
