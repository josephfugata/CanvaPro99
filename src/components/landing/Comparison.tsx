...
const features = [
  ...
  { feature: '100+ million premium assets', free: false, pro: true, lifetime: true },
    ...
    <section id="comparison" className="py-20 md:py-32 bg-secondary/50">
      <div className="container">
        <div className="text-center mb-16">
          <h2 className="font-headline text-4xl md:text-5xl font-bold">The Choice is Obvious</h2>
          <p className="max-w-3xl mx-auto mt-4 text-lg text-muted-foreground">
            See how our lifetime deal stacks up against the official Canva plans. More value, for a fraction of the cost.
          </p>
        </div>
        <div className="overflow-x-auto">
          <div className="grid grid-cols-3 min-w-[700px] md:min-w-0 md:w-full gap-4 items-end">
            ...
            <div className="relative">
              <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-accent text-accent-foreground px-4 py-1 rounded-full text-sm font-bold shadow-lg">BEST VALUE</div>
              <Card className="text-center bg-primary/10 border-primary shadow-2xl p-4">
                <CardTitle className="font-headline text-2xl text-primary">Our P99 Deal</CardTitle>
              </Card>
            </div>
