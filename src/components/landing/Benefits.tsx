...
export default function Benefits() {
  return (
    <section id="benefits" className="w-full py-20 md:py-32 bg-secondary">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefits.map((benefit, index) => (
            <Card key={index} className="bg-background border-border/50 shadow-md hover:shadow-xl transition-shadow duration-300">
              <CardHeader>
